    ...
    <div role="tabpanel" class="tab-pane fade<?php echo ($aba == 'home' ? ' in active' : '') ?>" id="home">
        <form method="post" action="">
            <div class="form-group">
                <img src="<?php echo base_url($foto_docente) ?>" alt="..." class="img-thumbnail">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="titulacao" name="titulacao" value="<?php echo $docente->titulacao ?>" placeholder="Ex: Doutor em Química" >
            </div>
            <div class="form-group">
                <label for="descricao">Descrição:</label>
                <textarea class="form-control" id="descricao" name="descricao" rows="7" placeholder="Coloque aqui uma breve descrição sobre você"><?php echo $docente->descricao ?></textarea>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form method="post" action="<?php echo base_url('home/alterar_foto') ?>" enctype="multipart/form-data">
